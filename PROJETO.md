...
- Serviço de geração de documentos oficiais em PDF (Memorial Descritivo, Formulário Oficial de Solicitação e Parecer Técnico).
...
- Reutilização da infraestrutura compartilhada de geração de documentos oficiais para Memorial, Formulário de Solicitação e Parecer Técnico;
- Padronização visual dos documentos administrativos emitidos pela Comissão de RSC;
...
| UC004 | Gerar Documentos Oficiais | RN101, RN102 | Documentos Oficiais | Memorial / Formulário / Parecer / Pacote ZIP | GET /api/documentos-oficiais/** | Visualização e Download | TS004 | Implementado |
